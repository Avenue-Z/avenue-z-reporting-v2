...
// PR-1 (Paul QA): the pill is positive divided by (positive plus negative) over ALL
// classified sentiment, while the Positive/Negative theme columns below are only a
// top-8, dominant-polarity subset. Summing the visible themes will not reproduce the
// pill percentage, which read as a mismatch in live QA. This tooltip explains the
// scope difference without changing the pill's math, label, or value.
const PILL_SCOPE_TOOLTIP =
  'This percentage reflects all classified sentiment for the selected models and period, not only the themes listed below, which are a top subset. It will not always match a sum of the themes shown.'
        ...
        {!noData && (() => {
          ...
          return (
            ...
            >
              ...
              <InfoTooltip text={PILL_SCOPE_TOOLTIP} />
            </span>
          )
        })()}
      </header>
