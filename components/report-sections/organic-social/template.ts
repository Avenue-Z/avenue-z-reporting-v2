...
export const ORGANIC_SOCIAL_TEMPLATE: SectionTemplate = {
  order: [
    ...
    { id: 'top-content', version: 1 },
  ],
  labels: {},
  thresholds: {},
}

// Platform subpages share ONE composition. The follower-graph part (M3) inserts as the
// second entry; it is intentionally ABSENT here and in Overview until M3 builds it.
