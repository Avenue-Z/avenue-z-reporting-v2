...
test('top-content@1 golden (Suspense skeleton)', () => {
  const impl = ORGANIC_SOCIAL_PARTS['top-content'][1]
  const resolved = { id: 'top-content', version: 1, label: impl.defaultLabel }
