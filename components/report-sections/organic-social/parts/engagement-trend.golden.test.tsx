...
test('engagement-trend@1 golden (Suspense skeleton)', () => {
  const impl = ORGANIC_SOCIAL_PARTS['engagement-trend'][1]
  const resolved = { id: 'engagement-trend', version: 1, label: impl.defaultLabel }
