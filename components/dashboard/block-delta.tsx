// components/dashboard/block-delta.tsx
import { computeDelta } from '@/lib/metrics'
import type { ResolveResult } from '@/lib/dashboard/types'
import { MetricDelta } from '@/components/charts/metric-delta'
...
export async function BlockDelta({
  ...
  return <MetricDelta delta={delta} label={deltaSuffix(compareRange)} />
}
