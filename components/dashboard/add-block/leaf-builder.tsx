...
const DS_OPTIONS: { value: string; label: string }[] = [
  ...
  // Shopify is intentionally omitted here — the Supermetrics SHP source hangs for
  // our stores. Shopify data flows through the direct ShopifyQL source instead
  // (see the 'shopify' branch below + lib/shopify/catalog.ts).
]
