...
| **FB-006** | Tina — Biggest Winners / Biggest Losers side-by-side cards on AEO Overview between Model Breakdown and Leaderboard. Computes per-prompt rank delta from real Peec data (current vs prior period). Symmetrical, scroll-bounded (`max-h-[400px]`), hides when empty (Profound, brand-new projects). | `364f696` | ✅ done |
