...
- **Interim behavior (grounded, not a product choice):** the Overview ships with blended **Spend** and **Clicks**; Leads and Cost-per-lead render `—` (unavailable) because the defining fact is missing.
- **Owner:** Dianna. **Needs an answer ASAP** — it gates a headline metric.
