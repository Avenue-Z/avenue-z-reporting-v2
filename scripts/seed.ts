...
import { clients, users, type PRConfig, type PaidSearchConfig, type MetaConfig, type LinkedInConfig, type SalesforceConfig, type ReportSlug } from '../lib/db/schema'
...
async function main() {
  for (const c of SEED) {
    const clientValues = {
      ...
      salesforceConfig: c.salesforceConfig,
